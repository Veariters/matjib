...
<div style="position: absolute; left: 35%; font-size:2em;"><b>글수정</b></div><br><br>
	<form action="f_boardUpdateProc.jsp?pageNum=<%=pageNum%>" method="post" name="writeForm" onsubmit="return writeSave()" encType="multipart/form-data">
		<table width="400" border="1" cellpadding="0" cellspacing="0" align="center" bgcolor="<%=bodyback_c%>">
			...
			<tr>
				<td width="70" bgcolor="<%=value_c%>" align="center">기존파일<br><%=article.getMf_image() %></td>
				<td width="150"><input type="file" name="mf_image" ></td>
			</tr>
			<tr>
