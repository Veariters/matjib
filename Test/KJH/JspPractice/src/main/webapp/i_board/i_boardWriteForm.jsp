...
<form action="i_boardProc.jsp" name="i_boardWriteForm" method="post" onsubmit="return writeSave()" enctype="multipart/form-data">
...
<table width="400" border="1" cellpadding="0" cellspacing="0" align="center" bgcolor="<%=bodyback_c%>">
	...
	String realPath = request.getServletContext().getRealPath("c:\\upload\\");
	...
	fileName = multipartRequest.getFilesystemName("");
	
	%>
	<tr>
		<td width="70" bgcolor="<%=value_c%>" align="center">이미지</td>

		<td width="150"><input type="file" name="fileName1"></td>
	</tr>
<%}catch(Exception e){} %>
	<tr>
