...
<div style="position: absolute; left: 35%; font-size:2em;"><b>글수정</b></div><br><br>
	<form action="i_boardUpdateForm.jsp?pageNum=<%=pageNum%>" method="post" name="i_boardUpdateForm" onsubmit="return checkUpdateForm()">
	...
	<form action="i_boardUpdateProc.jsp?pageNum=<%=pageNum%>" name="i_boardUpdateForm" encType="multipart/form-data" method="post" onsubmit="return checkPass()">
