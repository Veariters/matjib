...
function deleteSave(){
	...
	if(document.i_boardWriteForm.add.value < 0 || document.i_boardWriteForm.add.value > 9 ||document.i_boardWriteForm.add.value==""){
		alert("적절한 숫자를 입력해주세요(0~9)");
		document.i_boardWriteForm.add.focus();
		return false;
	}
...
function checkUpdateForm(){
	...
	if(document.i_boardUpdateForm.mi_writer.value==""){
		alert("작성자를 입력해주세요.");
		document.i_boardUpdateForm.mi_writer.focus();
		return false;
	}
	
	if(document.i_boardUpdateForm.mi_subject.value==""){
		alert("제목을 입력해주세요.");
		document.i_boardUpdateForm.mi_subject.focus();
		return false;
	}
	
	if(document.i_boardUpdateForm.mi_content.value==""){
		alert("내용을 입력해주세요.");
		document.i_boardUpdateForm.mi_content.focus();
		return false;
	}
	
	if(document.i_boardUpdateForm.add.value < 0 || document.i_boardUpdateForm.add.value > 9 || document.i_boardUpdateForm.add.value==""){
		alert("적절한 숫자를 입력해주세요(0~9)");
		document.i_boardUpdateForm.add.focus();
		return false;
	}
...
function checkPass(){
	...
	if(document.i_boardUpdateForm.add.value < 0 || document.i_boardUpdateForm.add.value > 9 || document.i_boardUpdateForm.add.value==""){
		...
		if(document.i_boardUpdateForm.mi_pass.value==""){
		alert("비밀번호를 입력해주세요.");
		document.i_boardUpdateForm.mi_pass.focus();
		return false;
	}
}
