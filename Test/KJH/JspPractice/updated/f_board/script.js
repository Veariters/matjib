...
function checkWriteForm(){
	...
	if(document.f_boardWriteForm.mf_writer.value==""){
		alert("작성자를 입력해주세요.");
		document.f_boardWriteForm.mf_writer.focus();
		return false;
	}
	
	if(document.f_boardWriteForm.mf_subject.value==""){
		alert("제목을 입력해주세요.");
		document.f_boardWriteForm.mf_subject.focus();
		return false;
	}
	
	if(document.f_boardWriteForm.mf_content.value==""){
		alert("내용을 입력해주세요.");
		document.f_boardWriteForm.mf_content.focus();
		return false;
	}
	
	if(document.f_boardWriteForm.mf_pass.value==""){
		alert("비밀번호를 입력해주세요.");
		document.f_boardWriteForm.mf_pass.focus();
		return false;
	}
	
	if(document.f_boardWriteForm.add.value < 0 || document.f_boardWriteForm.add.value > 9 || document.f_boardWriteForm.add.value==""){
		alert("적절한 숫자를 입력해주세요(0~9)");
		document.f_boardWriteForm.add.focus();
		return false;
	}
...
function checkUpdateBoard(){
	...
	if(document.f_boardUpdateForm.mf_writer.value==""){
		alert("작성자를 입력해주세요.");
		document.f_boardUpdateForm.mf_writer.focus();
		return false;
	}
	
	if(document.f_boardUpdateForm.mf_subject.value==""){
		alert("제목을 입력해주세요.");
		document.f_boardUpdateForm.mf_subject.focus();
		return false;
	}
	
	if(document.f_boardUpdateForm.mf_content.value==""){
		alert("내용을 입력해주세요.");
		document.f_boardUpdateForm.mf_content.focus();
		return false;
	}
	
	if(document.f_boardUpdateForm.mf_pass.value==""){
		alert("비밀번호를 입력해주세요.");
		document.f_boardUpdateForm.mf_pass.focus();
		return false;
	}

	if(document.f_boardUpdateForm.add.value < 0 || document.f_boardUpdateForm.add.value > 9 || document.f_boardUpdateForm.add.value == ""){
		alert("적절한 숫자를 입력해주세요(0~9)");
		document.f_boardUpdateForm.add.focus();
		return false;
	}
}
