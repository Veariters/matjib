...
public class RecommendDAO {
	...
	*/
	...
	/*
	// 추천취소를 위한 추천디비 삭제
	public void recommendDelete(int num, String id) {
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String sql = "";
		...
		try { 
			con = getConnection();
			pstmt = con.prepareStatement("delete from recommend where num=?, id=?");
			pstmt.setInt(1, num);
			pstmt.setString(2, id);
			pstmt.executeUpdate();
	...
	*/
	...
	/*
	 * // 비추천을 위해 추천디비에서 삭제 public void recommendDelete(int num, String id) {
	 * Connection con = null; PreparedStatement pstmt = null; ResultSet rs = null;
	 * String sql = "";
	 * 
	 * try { con = getConnection(); pstmt =
	 * con.prepareStatement("delete from recommend where num=?, id=?");
	 * pstmt.setInt(1, num); pstmt.setString(2, id); pstmt.executeUpdate();
	 * 
