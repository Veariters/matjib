...
public class R_BoardDAO { // 占쌉쏙옙占쏙옙 占쌜억옙占쏙옙 占쏙옙占쏙옙占� 占쏙옙占쏙옙占쏙옙 占쌨쇽옙占쏙옙
	...
	public int deleteArticle(int num, String pass) { // 占쏙옙 占쏙옙占쏙옙 처占쏙옙占쏙옙 占쌨쇽옙占쏙옙 占쏙옙占쏙옙(DB占쏙옙占쏙옙占쏙옙橘占싫ｏ옙占� 占쏙옙占싹울옙 占쏙옙占쏙옙)
		...
		try {
			...
			if (rs.next()) {
				...
				if (dbpass.equals(pass)) { // 占쏙옙橘占싫ｏ옙占� 占쏙옙치占쏙옙 占쏙옙占� --> 占쏙옙占쏙옙 처占쏙옙
